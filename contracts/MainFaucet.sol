...
contract MainFaucet is Pausable {
    ...
    event Sent(address indexed _wallet, uint256 indexed _amount, uint256 indexed _at);

    // Event to track the number of times a wallet has been used
    event Received(address indexed _wallet, uint256 indexed _amount, uint256 indexed _at);
